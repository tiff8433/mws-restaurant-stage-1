...
var CACHE_VERSION = "mws-apps-v2";
var CACHE_FILES = ["/", "/index.html", "/restaurant.html", "/register.js", "/css/styles.css", "/js/dbhelper.js", "/js/main.js", "/js/restaurant_info.js"]; // add images to files to cache

for (var i = 1; i < 11; i++) {
  var prefix = "/images/".concat(i);
  CACHE_FILES.push("".concat(prefix, "-320x240.jpg"));
  CACHE_FILES.push("".concat(prefix, "-1600_large_2x.jpg"));
  CACHE_FILES.push("".concat(prefix, "-large.jpg"));
}

; // Listen for install event, set callback

self.addEventListener('install', function (event) {
  console.log("Attempting to install service worker and cache static assets ".concat(CACHE_VERSION));
...
},{}]},{},["../../../../../usr/local/lib/node_modules/parcel-bundler/lib/builtins/hmr-runtime.js","service-worker.js"], null)
